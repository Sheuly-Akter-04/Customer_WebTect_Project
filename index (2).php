...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.1&nocache=2052430811ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.1" media="print" id="printcss">
    <title>localhost / 127.0.0.1 / agencycustomer | phpMyAdmin 5.1.1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/database/structure.js?v=5.1.1"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/table/change.js?v=5.1.1"></script>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=agencyreviewadd">`agencycustomer`.`agencyreviewadd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=umrahpackageadd">`agencycustomer`.`umrahpackageadd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=customersignup">`agencycustomer`.`customersignup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=tourpackageadd">`agencycustomer`.`tourpackageadd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=hotelandtransportation">`agencycustomer`.`hotelandtransportation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=agencycustomer&table=agencyreview">`agencycustomer`.`agencyreview`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel-agency&table=customersignup">`travel-agency`.`customersignup`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel-agency&table=tourpackage">`travel-agency`.`tourpackage`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel-agency&table=umrahpackage">`travel-agency`.`umrahpackage`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travel-agency&table=hoteltrasportation">`travel-agency`.`hoteltrasportation`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='New'>New</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.YWdlbmN5Y3VzdG9tZXI=" data-vpath="cm9vdA==.YWdlbmN5Y3VzdG9tZXI=" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=agencycustomer&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=agencycustomer' title='Structure'>agencycustomer</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Structure'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Structure'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Structure'>phpmyadmin</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cHJvZHVjdA==" data-vpath="cm9vdA==.cHJvZHVjdA==" data-pos="0""></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=product&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=product' title='Structure'>product</a><div class="clearfloat"></div></li>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php?route=%2Fdatabase%2Fstructure&db=agencycustomer&server=1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="4f724c7a485577795c6441296e233d71">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="127.0.0.1">
        ...
        <a href="index.php?route=/database/structure&db=agencycustomer" data-raw-text="agencycustomer">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=agencycustomer">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                              <span class="sr-only">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=agencycustomer">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=agencycustomer">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=agencycustomer">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=agencycustomer">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=agencycustomer">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=agencycustomer">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=agencycustomer&checkprivsdb=agencycustomer&viewing_mode=db">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=agencycustomer">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=agencycustomer">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=agencycustomer">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&db=agencycustomer">
              <img src="themes/dot.gif" title="Tracking" alt="Tracking" class="icon ic_eye">&nbsp;Tracking
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=agencycustomer">
              <img src="themes/dot.gif" title="Designer" alt="Designer" class="icon ic_b_relations">&nbsp;Designer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&db=agencycustomer">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php?route=%2Fdatabase%2Fstructure&db=agencycustomer&server=1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="4f724c7a485577795c6441296e233d71">
  <input type="hidden" name="submit_save" value="DbStructure">
<ul class="tabs responsivetable row">
      <li><a href="#DbStructure">Database structure</a></li>
  </ul>
<div class="tabs_contents col">
<fieldset class="optbox" id="DbStructure">
<legend>Database structure</legend>
    <p>Choose which details to show in the database structure (list of tables).</p>
<table class="pma-table" width="100%" cellspacing="0">
<tr><th><label for="ShowDbStructureCharset">Show table charset</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureCharset" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the charset for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureCharset" id="ShowDbStructureCharset"></span><a class="restore-default hide" href="#ShowDbStructureCharset" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureComment">Show table comments</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureComment" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the comments for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureComment" id="ShowDbStructureComment"></span><a class="restore-default hide" href="#ShowDbStructureComment" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureCreation">Show creation timestamp</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureCreation" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the Creation timestamp for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureCreation" id="ShowDbStructureCreation"></span><a class="restore-default hide" href="#ShowDbStructureCreation" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureLastUpdate">Show last update timestamp</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureLastUpdate" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the Last update timestamp for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureLastUpdate" id="ShowDbStructureLastUpdate"></span><a class="restore-default hide" href="#ShowDbStructureLastUpdate" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureLastCheck">Show last check timestamp</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureLastCheck" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the Last check timestamp for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureLastCheck" id="ShowDbStructureLastCheck"></span><a class="restore-default hide" href="#ShowDbStructureLastCheck" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
</div>
</form>
<script type="text/javascript">
...
</div></div>  <div id="tableslistcontainer">
...
<input type="hidden" name="db" value="agencycustomer"><input type="hidden" name="token" value="4f724c7a485577795c6441296e233d71">
<div class="table-responsive">
<table class="table table-light table-striped table-hover table-sm w-auto data">
    <thead class="thead-light">
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=table&sort_order=DESC" title="Sort" onmouseover="$('.sort_arrow').toggle();" onmouseout="$('.sort_arrow').toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Action            </th>
                        <th>
                <a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=records&sort_order=DESC" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=type&sort_order=ASC" title="Sort">Type</a></th>
                <th><a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=collation&sort_order=ASC" title="Sort">Collation</a></th>
            
                                            <th><a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=size&sort_order=DESC" title="Sort">Size</a></th>
                                <th><a href="index.php?route=/database/structure&db=agencycustomer&pos=0&sort=overhead&sort_order=DESC" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="AGENCYREVIEWADD">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="agencyreviewadd"
            id="checkbox_tbl_1">
    </td>
    <th>
        <a href="index.php?route=/sql&db=agencycustomer&table=agencyreviewadd&pos=0" title="">
            agencyreviewadd
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="2a97d043601dfbd9b8ecb796e809365c_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=agencycustomer&ajax_request=1&favorite_table=agencyreviewadd&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="ac460922ae7086a64ae247a1b5d55cb0">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=agencycustomer&table=agencyreviewadd&pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=agencycustomer&table=agencyreviewadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=agencycustomer&table=agencyreviewadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=agencycustomer&table=agencyreviewadd"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=agencycustomer&table=agencyreviewadd&sql_query=TRUNCATE+%60agencyreviewadd%60&message_to_show=Table%2Bagencyreviewadd%2Bhas%2Bbeen%2Bemptied.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=agencycustomer&table=agencyreviewadd&reload=1&purge=1&sql_query=DROP+TABLE+%60agencyreviewadd%60&message_to_show=Table+agencyreviewadd+has+been+dropped.">
                <span class="nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
    
                    
                <td class="value tbl_rows text-monospace text-right"
            data-table="agencyreviewadd">
                            0
                ...
                <a href="index.php?route=/table/structure&db=agencycustomer&table=agencyreviewadd#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="CUSTOMERSIGNUP">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=agencycustomer&table=customersignup&pos=0" title="">
            customersignup
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="28cb6a90001a6819d138fe76982111f6_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=agencycustomer&ajax_request=1&favorite_table=customersignup&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="59d99408df752ab678e395b2b99a50d3">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=agencycustomer&table=customersignup&pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=agencycustomer&table=customersignup">
          <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=agencycustomer&table=customersignup">
          <span class="nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=agencycustomer&table=customersignup"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=agencycustomer&table=customersignup&sql_query=TRUNCATE+%60customersignup%60&message_to_show=Table%2Bcustomersignup%2Bhas%2Bbeen%2Bemptied.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=agencycustomer&table=customersignup&reload=1&purge=1&sql_query=DROP+TABLE+%60customersignup%60&message_to_show=Table+customersignup+has+been+dropped.">
                <span class="nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="customersignup">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&db=agencycustomer&table=customersignup#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
            ...
            <tr id="row_tbl_3" data-filter-row="HOTELANDTRANSPORTATION">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="hotelandtransportation"
            id="checkbox_tbl_3">
    </td>
    <th>
        <a href="index.php?route=/sql&db=agencycustomer&table=hotelandtransportation&pos=0" title="">
            hotelandtransportation
                ...
                <td class="text-center d-print-none">
                                    <a id="b34e3e385cc35566858cea3c778608c6_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=agencycustomer&ajax_request=1&favorite_table=hotelandtransportation&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="04d65f04c6181d6ac89edfede3b9c56d">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=agencycustomer&table=hotelandtransportation&pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=agencycustomer&table=hotelandtransportation">
          <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=agencycustomer&table=hotelandtransportation">
          <span class="nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=agencycustomer&table=hotelandtransportation"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=agencycustomer&table=hotelandtransportation&sql_query=TRUNCATE+%60hotelandtransportation%60&message_to_show=Table%2Bhotelandtransportation%2Bhas%2Bbeen%2Bemptied.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=agencycustomer&table=hotelandtransportation&reload=1&purge=1&sql_query=DROP+TABLE+%60hotelandtransportation%60&message_to_show=Table+hotelandtransportation+has+been+dropped.">
                <span class="nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
                ...
                <td class="value tbl_rows text-monospace text-right"
            data-table="hotelandtransportation">
                            2
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&db=agencycustomer&table=hotelandtransportation#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
            ...
            <tr id="row_tbl_4" data-filter-row="TOURPACKAGEADD">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="tourpackageadd"
            id="checkbox_tbl_4">
    </td>
    <th>
        <a href="index.php?route=/sql&db=agencycustomer&table=tourpackageadd&pos=0" title="">
            tourpackageadd
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="990fd28456fcd81e4d3965dcd3d57394_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=agencycustomer&ajax_request=1&favorite_table=tourpackageadd&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="5d43390eb4cb4c64d798b0cd9e6ec132">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=agencycustomer&table=tourpackageadd&pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=agencycustomer&table=tourpackageadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=agencycustomer&table=tourpackageadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=agencycustomer&table=tourpackageadd"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=agencycustomer&table=tourpackageadd&sql_query=TRUNCATE+%60tourpackageadd%60&message_to_show=Table%2Btourpackageadd%2Bhas%2Bbeen%2Bemptied.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=agencycustomer&table=tourpackageadd&reload=1&purge=1&sql_query=DROP+TABLE+%60tourpackageadd%60&message_to_show=Table+tourpackageadd+has+been+dropped.">
                <span class="nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="tourpackageadd">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&db=agencycustomer&table=tourpackageadd#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
            ...
            <tr id="row_tbl_5" data-filter-row="UMRAHPACKAGEADD">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="umrahpackageadd"
            id="checkbox_tbl_5">
    </td>
    <th>
        <a href="index.php?route=/sql&db=agencycustomer&table=umrahpackageadd&pos=0" title="">
            umrahpackageadd
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="bbba29cf8b27efc19356d3d996075884_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=agencycustomer&ajax_request=1&favorite_table=umrahpackageadd&add_favorite=1"
    title="Add to Favorites"
    data-favtargets="664b37826a7da204adc413960da3e131">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=agencycustomer&table=umrahpackageadd&pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=agencycustomer&table=umrahpackageadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=agencycustomer&table=umrahpackageadd">
          <span class="nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=agencycustomer&table=umrahpackageadd"><span class="nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=agencycustomer&table=umrahpackageadd&sql_query=TRUNCATE+%60umrahpackageadd%60&message_to_show=Table%2Bumrahpackageadd%2Bhas%2Bbeen%2Bemptied.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=agencycustomer&table=umrahpackageadd&reload=1&purge=1&sql_query=DROP+TABLE+%60umrahpackageadd%60&message_to_show=Table+umrahpackageadd+has+been+dropped.">
                <span class="nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="umrahpackageadd">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&db=agencycustomer&table=umrahpackageadd#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
...
<tr>
    ...
    <th class="tbl_num text-nowrap">
                ...
                <th colspan="7" class="d-print-none">Sum</th>
                                                <th class="value tbl_rows text-monospace text-right">24</th>
        ...
        <th>
                    ...
                    utf8mb4_general_ci
                                    ...
                                    <th class="value tbl_size text-monospace text-right">80.0 KiB</th>

                                <th class="value tbl_overhead text-monospace text-right">0 B</th>
  ...
  <p class="print_ignore">
    <a href="#" id="printView">
      <span class="nowrap"><img src="themes/dot.gif" title="Print" alt="Print" class="icon ic_b_print">&nbsp;Print</span>
    </a>
    <a href="index.php?route=/database/data-dictionary&db=agencycustomer&goto=index.php%3Froute%3D%2Fdatabase%2Fstructure" target="print_view">
      <span class="nowrap"><img src="themes/dot.gif" title="Data dictionary" alt="Data dictionary" class="icon ic_b_tblanalyse">&nbsp;Data dictionary</span>
    </a>
  </p>

  <form id="create_table_form_minimal" method="post" action="index.php?route=/table/create" class="lock-page">
    <fieldset>
        <legend>
        <img src="themes/dot.gif" title="" alt="" class="icon ic_b_table_add">        Create table        </legend>
        <input type="hidden" name="db" value="agencycustomer"><input type="hidden" name="token" value="4f724c7a485577795c6441296e233d71">
        <div class="formelement">
            Name:
  ...
  <div id="selflink" class="print_ignore"><a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=agencycustomer&amp;server=1" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="Open new phpMyAdmin window" alt="Open new phpMyAdmin window" class="icon ic_window-new"></a></div>
